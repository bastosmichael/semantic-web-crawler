...
/// PcreWrapper wraps the PCRE C API into a more perl-like syntax
/**
 * PcreWrapper wraps the PCRE C API into a more perl-liek syntax.  It supports single matching,
...
public:
	...
	PcreWrapper(const std::string & s, unsigned opts );

	/// s is the regular expression, opts is a perl-like string of modifier letters "gi" is global and case insensitive
	PcreWrapper(const std::string & s, const std::string & opts = "");

	/// s is the regular expression, opts are PCRE flags bit-wise or'd together
	PcreWrapper(const char * s, unsigned opts );

	/// s is the regular expression, opts is a perl-like string of modifier letters "gi" is global and case insensitive  
	PcreWrapper ( const char * s, const std::string & opts = "" );

	/// PcreWrapper copy constructor
	PcreWrapper(const PcreWrapper & r);

	/// PcreWrapper = PcreWrapper assignment operator
	//const PcreWrapper & operator = (const PcreWrapper & r);
